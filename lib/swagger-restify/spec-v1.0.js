...
function SpecV10 (opt) {
  ...
  this._readApis(opt.apis, function(err, resources, resourceDescriptors) {
    if (err) {
      throw err;
    }
...
SpecV10.prototype._generate = function(opt) {
    ...
    this.descriptor.swaggerURL = (opt.swaggerURL) ? opt.swaggerURL : '/swagger';
    this.descriptor.swaggerJSON = (opt.swaggerJSON) ? opt.swaggerJSON : '/api-docs.json';
...
SpecV10.prototype.getDescription = function(req, opt, cb) {
